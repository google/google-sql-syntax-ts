...
const STRING_AGG = {
  name: 'STRING_AGG',
  args:
      '[DISTINCT]  expression [, delimiter]  [ORDER BY key [{ASC|DESC}] [, ... ]]  [LIMIT n]',
  description: '',
  url: '',
};
...
const JSON_EXTRACT = {
  name: 'JSON_EXTRACT',
  args: [{args: 'json_string_expr, json_path'}, {args: 'json_expr, json_path'}],
...
const ST_GEOGFROMTEXT_2 = {
  name: 'ST_GEOGFROMTEXT',
  args:
      'wkt_string[, oriented => boolean_constant_1][, planar => boolean_constant_2][, make_valid => boolean_constant_3]',
  description: '',
  url: '',
};
