...
const JSON_EXTRACT_SCALAR = {
  ...
  description:
    "Extracts a scalar value and then returns it as a string. A " +
...
const JSON_QUERY_ARRAY = {
  ...
  description:
    "Extracts an array of JSON values, such as arrays or objects, " +
...
const JSON_EXTRACT_STRING_ARRAY = {
  ...
  description:
    "Extracts an array of scalar values and returns an array of " +
...
const PARSE_JSON = {
  ...
  description:
    "Takes a SQL STRING value and returns a SQL JSON value. The " +
...
const TO_JSON = {
  ...
  description:
    "Takes a SQL value and returns a JSON value. The value must be" +
...
const BOOL = {
  ...
  args: "json_expr",
  description:
    "Takes a JSON expression, extracts a JSON boolean, and " +
...
const INT64 = {
  ...
  args: "json_expr",
  description:
    "Takes a JSON expression, extracts a JSON number and returns " +
...
const JSON_TYPE = {
  ...
  args: "json_expr",
  description:
    "Takes a JSON expression and returns the type of the " +
...
const STRING = {
  ...
  args: [
    ...
    },
    {
      args: "json_expr",
      description:
        "Takes a JSON expression, extracts a JSON string, and " +
 ...
 */
export const BIGQUERY_FUNCTIONS: FunctionDescription[] = [
  ANY_VALUE,
  ARRAY_AGG,
  ARRAY_CONCAT_AGG,
  AVG,
