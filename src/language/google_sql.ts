...
export class GoogleSqlDefinition implements SqlDefinition {
  ...
  private readonly FUNCTIONS_WITH_INFO: FunctionDescription[] = [
    {
      ...
      args: "numeric_expr",
      description:
        "Computes absolute value. Returns an error if the" +
        "argument is" +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Computes the inverse hyperbolic cosine of <numeric_expr>. " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Returns any value from the input or NULL if there are " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Returns the approximate result for COUNT(DISTINCT <expr>)" +
    ...
    },
    {
      ...
      args: "expr, number",
      description:
        "Returns the approximate top elements of <expr>. The " +
    ...
    },
    {
      ...
      description:
        "Concatenates one or more arrays with the same element type " +
        "into a single array.",
    },
    {
      ...
      args: "expr",
      description:
        "Concatenates elements from <expr> of type ARRAY, returning a " +
    ...
    },
    {
      ...
      description:
        "Returns a concatenation of the elements in <array_expr> as a " +
    ...
    },
    {
      ...
      args: "value",
      description:
        "Returns the ASCII code for the first character of the " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Computes the principal value of the arc sine of <numeric_expr>. " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Computes the inverse hyperbolic tangent of <numeric_expr>. " +
    ...
    },
    {
      ...
      description:
        "Calculates the principal value of the arc tangent of Y/X using " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Returns the average of non-NULL input values, or NaN if the " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Performs a bitwise AND operation on expression and returns the " +
        "result.",
    },
    {
      name: "BIT_OR",
      args: "expr",
      description:
        "Performs a bitwise OR operation on expression and returns the " +
        "result.",
    },
    {
      name: "BIT_XOR",
    ...
    },
    {
      ...
      args: "value",
      description:
        "Returns the length of the <value> in bytes, regardless of " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Returns the smallest integral value (with FLOAT64 type) that is " +
    ...
    },
    {
      ...
      args: "value",
      description:
        "Returns the character that matches the input Unicode " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Computes the hyperbolic cosine of <numeric_expr>. Generates an " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Returns the count of TRUE values for <expr>. Returns 0 if there " +
    ...
    },
    {
      ...
      args: "",
      description:
        "Return the relative rank of a row defined as NP/NR. NP is " +
    ...
    },
    {
      ...
      description:
        "Converts a <timestamp_expr> to a DATE data type. It supports " +
    ...
    },
    {
      ...
      args: "",
      description:
        "Returns the ordinal (1-based) rank of each row within the " +
    ...
    },
    {
      ...
      args: "numeric_expr, numeric_expr",
      description:
        "Returns the result of integer division of X by Y. Division by " +
    ...
    },
    {
      ...
      args: "value1, value2",
      description:
        "Takes two values. Returns TRUE if <value2> is a suffix of " +
        "<value1>.",
    },
    {
      name: "EXP",
      args: "numeric_expr",
      description:
        "Computes e to the power of <numeric_expr>, also called the " +
    ...
    },
    {
      ...
      args: "value_expr",
      description:
        "Returns the value of the <value_expr> for the first row in the " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Returns the largest integral value (with FLOAT64 type) that is " +
    ...
    },
    {
      ...
      description:
        "BigQuery supports a FORMAT() function for formatting strings. " +
    ...
    },
    {
      ...
      description:
        "Returns NULL if any of the inputs is NULL. Otherwise, returns " +
    ...
    },
    {
      ...
      description:
        "Returns 0 or 1. Returns 1 if the " +
    ...
    },
    {
      ...
      args: "numeric_expr1, numeric_expr2",
      description:
        "Divides <numeric_expr1> by <numeric_expr2>; this function never " +
    ...
    },
    {
      ...
      description:
        "If expr is NULL, return null_result. Otherwise, return " +
    ...
    },
    {
      ...
      description:
        "Transform the <input> string with the first character in " +
    ...
    },
    {
      ...
      description:
        "Searches the occurrences of <search_value> in the " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Returns TRUE if the value is a NaN value. Returns NULL for " +
        "NULL inputs.",
    },
    {
      name: "JSON_ARRAY",
    ...
    },
    {
      ...
      args:
        "json_expr[, json_path][, include_arrays=>{ TRUE | FALSE }]" +
        "[, remove_empty=>{ TRUE | FALSE }]",
      description:
        "Recursively removes JSON nulls from JSON objects and " +
        "JSON arrays.",
      url: this.docsUrls
    ...
    },
    {
      ...
      description:
        "Returns the value of the <value_expr> on a preceding row. " +
    ...
    },
    {
      ...
      description:
        "Returns the last day from the <datetime_expression> that " +
    ...
    },
    {
      ...
      args: "value_expr",
      description:
        "Returns the value of the <value_expr> for the last row in the " +
        "current window frame.",
      url:
        "https://cloud.google.com/bigquery/docs/reference/standard-sql/" +
    ...
    },
    {
      ...
      args: "value_expr [, offset [, default_expr] ]",
      description:
        "Returns the value of the <value_expr> on a subsequent row. " +
    ...
    },
    {
      ...
      args: "numeric_expr1, numeric_expr2, ...",
      description:
        "Returns NULL if any of the inputs is NULL. Returns NaN if any " +
    ...
    },
    {
      ...
      args: "value, length",
      description:
        "Returns the specified number of leftmost characters from " +
    ...
    },
    {
      ...
      args: "value",
      description:
        "Returns the length of the value. The returned value is in " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Computes the natural logarithm of <numeric_expr>. Generates an " +
    ...
    },
    {
      ...
      description:
        "If only <numeric_expr> is present, LOG is a synonym of LN. " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Returns the logical AND of all non-NULL expressions. Returns " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Returns the logical OR of all non-NULL expressions. Returns " +
        "NULL if there are zero input rows or <expr> evaluates to NULL " +
        "for all rows.",
    },
    {
      ...
      args: "value",
      description:
        "For STRING arguments, returns the original string with all " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Returns the maximum value of non-NULL expressions. Returns NULL " +
    ...
    },
    {
      ...
      args: "expr1, expr2",
      description:
        "Returns the value of expr1 for which the value of expr2 " +
    ...
    },
    {
      ...
      args: "expr",
      description:
        "Returns the minimum value of non-NULL expressions. Returns NULL " +
        "if there are zero input rows or <expr> evaluates to NULL for " +
        "all rows. Returns NaN if the input contains a NaN.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Returns the value of <value_expr> at the Nth row of the current " +
    ...
    },
    {
      ...
      description:
        "This function divides the rows into <constant_integer_expr> " +
    ...
    },
    {
      ...
      args: "input",
      description:
        "An alias of BYTE_LENGTH. Returns the length of the " +
    ...
    },
    {
      ...
      description:
        "Uses a <format_string> and a string representation of a " +
    ...
    },
    {
      ...
      args: "value, regex",
      description:
        "Returns TRUE if <value> is a partial match for the regular " +
    ...
    },
    {
      ...
      description:
        "Returns a STRING where all substrings of <value> that match " +
    ...
    },
    {
      ...
      description:
        "Extracts a substring from <value> that matches a regular " +
    ...
    },
    {
      ...
      description:
        "If only <numeric_expr> is present, ROUND rounds <numeric_expr> " +
    ...
    },
    {
      ...
      args: "expr AS typename",
      description:
        "SAFE_CAST is identical to CAST, except it returns NULL instead " +
        "of raising an error.",
    },
    {
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Computes the hyperbolic sine of <numeric_expr>. Generates an " +
        "error if an overflow occurs.",
    },
    {
      name: "SOUNDEX",
      args: "input",
      description:
        "Returns a string that represents the Soundex code for " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Computes the square root of <numeric_expr>. Generates an error " +
    ...
    },
    {
      ...
      args: "expr, [, delimiter]",
      description:
        "Returns a value (either STRING or BYTES) obtained by " +
    ...
    },
    {
      ...
      description:
        "Returns the shortest distance in meters between two " +
    ...
    },
    {
      ...
      args: "value, position [, length]",
      description:
        "An alias of substr. Returns a substring of the " +
    ...
    },
    {
      ...
      args: "numeric_expr",
      description:
        "Computes tangent of <numeric_expr>. Generates an error if an " +
        "overflow occurs.",
    },
    {
      name: "TANH",
    ...
    },
    {
      ...
      description:
        "Adds <int64_expr> units of <date_part> to the timestamp, " +
    ...
    },
    {
      ...
      description:
        "Returns the number of whole specified <date_part> intervals " +
    ...
    },
    {
      ...
      args: "INT64_expr",
      description:
        "Interprets <INT64_expr> as the number of microseconds since " +
    ...
    },
    {
      ...
      args: "INT64_expr",
      description:
        "Interprets <INT64_expr> as the number of milliseconds since " +
        "1970-01-01 00:00:00 UTC.",
    },
    {
      ...
      args: "INT64_expr",
      description:
        "Interprets <INT64_expr> as the number of seconds since " +
        "1970-01-01 00:00:00 UTC.",
    },
    {
      name: "TIMESTAMP_SUB",
    ...
    },
    {
      ...
      args: "value1 [, value2]",
      description:
        "Removes all leading and trailing characters that match " +
    ...
    },
    {
      ...
      args: "numeric_expr [, decimal_places]",
      description:
        "If only <numeric_expr> is present, TRUNC rounds <numeric_expr> " +
    ...
    },
    {
      ...
      args: "array_expr",
      description:
        "The UNNEST operator takes an ARRAY and returns a table, with " +
  ...
  mergedSqlFunctions(): FunctionDescription[] {
    ...
    ).concat(this.FUNCTIONS_WITH_INFO);
    const sqlFunctionSet = new Set<string>(
      sqlFunctions.map((sqlFunction) => sqlFunction.name)
    );
    return sqlFunctions.concat(
      BIGQUERY_FUNCTIONS.filter(
        (sqlFunction) => !sqlFunctionSet.has(sqlFunction.name)
      )
    );
  }

  /** Functions. */
  readonly FUNCTIONS: string[] = this.mergedSqlFunctions().map((elem) => {
    return elem.name;
  });
  ...
  private readonly TVF_FUNCTIONS_WITH_INFO = [
    {
      name: "ML.EVALUATE",
      args:
        "MODEL model, TABLE table | (subquery) " +
    ...
    },
    {
      ...
      args:
        "TABLE table | (subquery), STRING range_column, " +
  ...
  private readonly TVF_FUNCTIONS = this.TVF_FUNCTIONS_WITH_INFO.map((elem) => {
    return elem.name;
  });
 ...
 */
export const googleSqlLanguageConfiguration: IRichLanguageConfiguration = {
...
/** The exported languaged definition for google sql. */
export function getGoogleSqlLanguageDefinition(
  docsUrls: DocsUrls
): GoogleSqlLanguageDefinition {
  ...
  return {
    ...
    keywords: googleSqlDefinition.FUNCTIONS.concat(
      googleSqlDefinition.CLAUSE_WORDS
    ).concat(googleSqlDefinition.KEYWORDS),
